...
public class Part
{
    ...
    {
        return "ClassPojo [id = "+id+", optimizedForStreaming = "+optimizedForStreaming+", duration = "+duration+", has64bitOffsets = "+has64bitOffsets+", file = "+file+", container = "+container+", Stream = "+Stream+", videoProfile = "+videoProfile+", audioProfile = "+audioProfile+", key = "+key+", size = "+size+"]";
    }
}